...
### CPU Exceptions - 1[https://yongj.in/rust%20os/rust-os-cpu-exceptions/]

### CPU Exceptions - 2[https://luv-n-interest.tistory.com/997]

### CPU Exceptions - 3[https://jihyewoo.tistory.com/18?category=936350]
...
<p>
Divide-by-zero Error는 DIV 또는 IDIV 명령을 사용하여 숫자를 0으로 나누거나 분할 결과가 너무 커서 대상에 표시할 수 없을 때 발생합니다.<br>
결함이 있는 DIV 또는 IDIV 명령은 코드의 어디에든 추가하기 쉽기 때문에 많은 OS 개발자들은 예외 처리 코드가 작동하는지 테스트하기 위해 이 예외를 사용합니다.<br>
...
<p>Debug Exceptions는 다음과 같은 경우에 발생합니다.</p>
<ul>
